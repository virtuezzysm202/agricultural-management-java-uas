        ...
        path("/api/pembelian", () -> {
            ...
            get("/:id", (req, res) -> {
                ...
                try {
                    ...
                    if (pembelian != null) return gson.toJson(pembelian);
                    res.status(404);
            ...
            put("/:id", (req, res) -> {
                ...
                try {
                    ...
                    if (ok) {
                        return gson.toJson(Map.of("message", "Pembelian berhasil diperbarui"));
                    }
                    res.status(404);
            ...
            delete("/:id", (req, res) -> {
                ...
                try {
                    ...
                    if (ok) {
                        return gson.toJson(Map.of("message", "Pembelian berhasil dihapus"));
                    }
                    res.status(404);
