                ...
                <div className="flex items-center gap-3">
                  <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                    <img
                      ...
                      alt="MacBook Pro 13”"
                      src="/images/product/product-01.jpg" // Pastikan path benar
                    />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                    <img
                      ...
                      src="/images/product/product-02.jpg" // Pastikan path benar
                    />
                  </div>
                  <div>
                    <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                    <img
                      ...
                      src="/images/product/product-03.jpg" // Pastikan path benar
                    />
                  </div>
                  <div>
                    <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                    <img
                      ...
                      src="/images/product/product-04.jpg" // Pastikan path benar
                    />
                  </div>
                  <div>
                    <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                ...
                <div className="flex items-center gap-3">
                  <div className="h-[50px] w-[50px] overflow-hidden rounded-md">
                    <img
                      ...
                      src="/images/product/product-05.jpg" // Pastikan path benar
                    />
                  </div>
                  <div>
                    <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">
