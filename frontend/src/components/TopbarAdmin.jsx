...
export default function TopbarAdmin() {
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-50 dark:border-gray-800 flex dark:text-gray-400 lg:h-11 lg:w-11 xl:border "
          ...
          <a className="xl:hidden" href="/" data-discover="true">
            <img
              className="dark:hidden"
              alt="Logo"
              src="./images/logo/logo.svg" // Pastikan path benar
            />
            <img
              className="hidden dark:block"
              alt="Logo"
              src="./images/logo/logo-dark.svg" // Pastikan path benar
            />
          </a>
          <button className="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-50 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 xl:hidden">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="relative">
            <button className="flex items-center text-gray-700 dropdown-toggle dark:text-gray-400">
              <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
                <img alt="User" src="/images/user/owner.png" />
              </span>
